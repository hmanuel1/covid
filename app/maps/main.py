...
def map_button_client(slider, rdate, width=80, height=60):
    ...
    # play button
    button = Button(label='► Play', width=80, height=60)
...
def build_us_map(us_map, state_map, palette, levels, dates, options):
    ...
    if side == 'client':
        ...
        button = map_button_client(slider, rdate, width=60, height=60)
    ...
    if side == 'server':
        ...
        button = map_button_server(slider, rdate, width=60, height=60)
